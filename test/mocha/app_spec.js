...
describe('file system checks', function () {
  describe('markup files are well-formed', function () {
    ...
    it('*.html is xhtml', async function () {
    ...
    it('*.xml', async function () {
      const files = await glob('**/*.xml', { ignore: 'node_modules/**' })
      // console.log(files)
    ...
    it('*.xconf', async function () {
      const files = await glob('**/*.xconf', { ignore: 'node_modules/**' })
      // console.log(files)
    ...
    it('*.odd', async function () {
      this.slow(1000)
      const files = await glob('**/*.odd', { ignore: 'node_modules/**' })
      // console.log(files)
